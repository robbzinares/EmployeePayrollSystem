            ...
            if (rs.next()) {
                ...
                if (rs.next()) {
                    ...
                    while (overtimeRs.next()) {
                        ...
                        myDocument.add(new Paragraph("Percentage: " + overtimeRs.getString("Percentage"), FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.PLAIN)));
                        ...
                        myDocument.add(new Paragraph("Salary Overtime: " + overtimeRs.getString("Salary_overtime"), FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.PLAIN)));
                        myDocument.add(new Paragraph("-------------------------------------------------------------------------------------------"));
                    }
